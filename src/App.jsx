            ...
            <Route path="/" element={
              <div className="gallery">
                <Link to="/graphic-design" className="gallery-item">
                  <img src="/images/image1.png" alt="Graphic Design" />
                ...
                <Link to="/game-design" className="gallery-item">
                  <img src="/images/image2.png" alt="Game Design" />
                ...
                <Link to="/animation" className="gallery-item">
                  <img src="/images/image3.png" alt="Animation" />
                ...
                <Link to="/illustration" className="gallery-item">
                  <img src="/images/image4.png" alt="Illustration" />
